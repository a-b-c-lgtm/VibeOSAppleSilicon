...
the other.  Milestone 46 closes that gap.
...
Up to milestone 45 the wallpaper was a single `fb_clear(WALLPAPER)`
...
We kept the dark horizontal bar at the bottom — milestone 47 will fill
