...
[chapter 12](12-preemption.md#the-eret-window-trap).
...
heartbeat lines from chapter 10. `Ctrl-A X` quits. With that
working, chapter 12 is a four-line edit to `irq_dispatch`.
