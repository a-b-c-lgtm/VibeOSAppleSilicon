# Chapter 151 — `environ[]`, getenv, setenv, unsetenv, putenv
...
[chapter 151] env.h POSIX surface (getenv/setenv/unsetenv/putenv/environ)
...
[Chapter 152](152-errno-convention.md) — flip every `__svc_*`
