# Chapter 48 — virtio-tablet, mouse focus, drag, and close

> *We added a window manager in chapter 47 and gave it
> a keyboard in chapter 46.  This chapter adds the second half of
...
a keyboard in chapter 46 by accepting the first virtio-input slot
...
Chapter 47 introduced `pump_input_into_wm()` so that a GUI app
