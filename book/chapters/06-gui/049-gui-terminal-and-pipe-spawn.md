# Chapter 49 — gui_term: a terminal in a window, and the synchronous-pipe spawn pattern

> *We have a window manager (chapter 47), a focused
> keyboard (chapter 46), and a working pointer (chapter 48).  The
...
2. **Re-render on every keystroke.**  The window is a passive
   ...
   you can't see it.  (At chapter 104 the bitmap font was
...
We already have a better tool: real pipes.  Chapter 29 added
...
chapter 29 — pipes, `spawn_pipe`, `wait`, the VFS, the heap, the
