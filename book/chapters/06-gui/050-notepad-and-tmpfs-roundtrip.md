# Chapter 50 — notepad: a real text editor in a window, and the writable-tmpfs round-trip

> *We have a window manager (chapter 47), a focused
> keyboard with shift+ctrl modifiers (chapter 46), a pointer
> (chapter 48), and a way to run other programs from inside a
> window (chapter 49).  This chapter builds the second classic
...
- A scrollable edit area (about 25 visible rows × 88 columns of
  the 8×16 bitmap font — chapter 104 swapped this for DejaVu
...
chapter 48, the linker detour) — the on-disk binary stays
