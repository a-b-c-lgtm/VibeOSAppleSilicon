# Chapter 21 — A read-only on-disk filesystem and `cat /mnt/...`

## Where we are

Chapter 20 left us able to read and write 512-byte sectors of a real
...
The VFS in chapter 16 had one job: walk a static `g_ramfs[]` table
...
That's milestone 13. After that, the world starts to look like a
real Unix.

Chapter 22 next: virtio-console, which gets us serial output through
