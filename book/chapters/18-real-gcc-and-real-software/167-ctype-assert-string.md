# Chapter 167 — `<ctype.h>`, `<assert.h>`, and the `str*` family
...
> chapter 166 (the expanded signal table).
...
chapter 167 uses both deliberately.
...
3. **`atoi`** — accepts leading whitespace and optional sign.
   No error reporting; that's `strtol`'s job (chapter 169).
...
### The TTY-echo gotcha (already documented in 166)
...
| `<errno.h>` | done | 149 |
| `<stdio.h>` (FILE*) | done | 150 |
| `<env.h>` (getenv) | done | 151 |
| `<sys/stat.h>`, `<fcntl.h>`, `<dirent.h>` | done | 153 |
| `<signal.h>` | done | 77 + 166 |
| `<setjmp.h>` | done | 165 |
| `<ctype.h>` | done | **167** |
| `<assert.h>` | done | **167** |
| `<string.h>` (str*) | done | **167** |
| `<string.h>` (mem*) | done | 124 (in `cstring.c`) |
| `<time.h>` | pending | 168 |
| `<stdlib.h>` qsort/bsearch/strtol | pending | 169 |
| `<stdlib.h>` getopt | pending | 169 |
| `<stdio.h>` %f/scanf | pending | 170 |

Once 170 lands, the surface is wide enough to start building
binutils (chapter 175).
...
The applied-to wave will hit during chapters 172–197 when the
