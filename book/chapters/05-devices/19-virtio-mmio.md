# Chapter 19 — virtio-mmio: bus, queues, and the modern transport

## Why virtio is the right place to start Part V

Up to this point our kernel has talked to exactly two real devices:
the PL011 UART (chapter 3) and the GIC (chapter 9). Both are
...
For milestone 11 we negotiate exactly one feature: `VIRTIO_F_VERSION_1`.
...
Chapter 20 takes everything in this chapter and uses it to do a
