# Chapter 77 — SIGCHLD and waitpid: parent-child plumbing
...
> remain deferred to chapter 78 (job control). Builds on
> chapter 76 (sigaction).
...
- Process groups, briefly — full pgrp/session semantics
  come with job control in chapter 78.
...
Chapter 76's dispatcher tail terminates the receiving
...
Same caveat as chapter 76: SIGCHLD fires at the parent's
