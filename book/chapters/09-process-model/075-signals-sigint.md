...
- Chapter 17 — Console keyboard input
- Chapter 10 — Threads
...
- Why Linux's signal-restart-or-EINTR debate exists (we'll
  pick a side in chapter 76).

## What this unlocks

- Ctrl-C actually does something.
- `kill <pid>` shell builtin.
- Catchable signals in chapter 76.
