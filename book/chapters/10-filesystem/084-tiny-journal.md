# Chapter 84 — A tiny journal: crash-consistency on a budget

In chapter 83 we put a 32-slot write-back cache in front of the
...
Chapter 83's cache changed the rules. Now all three writes can
