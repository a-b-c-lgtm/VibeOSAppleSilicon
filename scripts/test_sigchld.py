...
delivery on exit, waitpid(specific_pid), WNOHANG, the SIG_DFL =
ignore special case, and legacy wait() compatibility."""
import os, select, socket, subprocess, sys, time

ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
SOCK = "/tmp/osdev-serial-chldtest.sock"
