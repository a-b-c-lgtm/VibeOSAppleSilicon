# Chapter 52 — A WM rendering bug, surfaced by the launcher
...
> existed at this point in the book. Chapter 117 later moves compositing into
...
Chapter 51 wired the launcher to spawn a new `gui_term` whenever the
...
> **Forward note:** chapter 117 retires this code entirely. When the
