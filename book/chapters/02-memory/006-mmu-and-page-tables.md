...
We pick the simplest combination that works:
...
chapter 12 when we add per-process page tables — keeping page-
...
opportunity for it to suffer the early `stp/ldp`-on-Device
...
Identity-mapping the lower 2 GiB is a useful fixture at this
point, but it is not a real memory map. Real memory
