# Chapter 29 — Browsing the namespace: `SYS_LISTDIR` and `/bin/ls`

We've had a filesystem since chapter 12 and binaries on disk
since chapter 13. But to know what's actually *in* the FS you've
...
chapter 25): bounds-check both pointers up front, do the work
...
kernel/core/main.c              banner -> milestone 20
