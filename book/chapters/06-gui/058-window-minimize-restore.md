# Chapter 58 — Window minimize and restore

The desktop has had a working taskbar since Chapter 54, but every
...
The same issue would have lurked in the existing pre-minimize
