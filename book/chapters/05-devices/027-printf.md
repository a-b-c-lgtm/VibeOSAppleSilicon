# Chapter 27 — A `printf` for the user libc
...
shape as `malloc.h` from chapter 25: every `.c` that includes it
...
The argv echo also exercises chapter 26's stack layout — `argc=4`
