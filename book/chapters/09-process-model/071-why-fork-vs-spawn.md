# Chapter 71 — Why fork (and not just spawn)

> **Milestone in this chapter:** 65 — design prelude.
> **Code referenced:** none yet (chapter 72 implements `fork`).
>
...
The kernel has run with `spawn(path, args)` since chapter 16.
...
land in chapters 72–74.

## What this chapter adds

Argument and design. No code lands until chapter 72.
...
- The plan: chapter 72 lands fork (eager copy), 74 lands exec,
