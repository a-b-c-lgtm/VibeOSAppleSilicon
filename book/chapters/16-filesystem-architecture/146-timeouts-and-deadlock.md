# Chapter 146 — Step 6: per-request timeouts and deadlock detection

Chapter 145 ended with a warning. Userfs is now load-bearing
...
[chapter 141](141-kernel-userfs-module.md). This chapter
...
- **The prefer-data-over-signal rule from chapter 145's
...
## The deadlock detector (already shipped in 141)
...
[chapter 142 step 3](142-sys-mount-umount.md)). If procd
