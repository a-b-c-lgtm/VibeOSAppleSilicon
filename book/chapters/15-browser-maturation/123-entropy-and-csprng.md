# Chapter 123 — Entropy: virtio-rng and a kernel CSPRNG

Chapter 122 closed the JavaScript loop. Forms could now react to
...
virtio-mmio-v2 driver (the first was `virtio_snd`, chapter 97).
...
on the modern transport (chapter 97 explained the v1 vs v2
...
+ `read_until`) is the same one introduced in chapter 97 for
...
- **Chapter 132**: build BearSSL out-of-tree, package it as
...
- **Chapter 153**: end-to-end test against a public HTTPS site.
