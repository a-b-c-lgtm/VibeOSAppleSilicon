# Chapter 45 — Kill ring: Ctrl-K, Ctrl-U, Ctrl-W, Ctrl-Y

Chapter 44 gave us cursor movement and mid-line editing.  This
...
Identical structure to mid-line `printable insert` from chapter 44,
...
- `userspace/sh/sh.c`:
  ...
  - Help text updated.
- `kernel/core/main.c`: banner -> milestone 36.
