# Chapter 21 — Loading user binaries from disk

## What we just stopped doing

Up through chapter 20 every user program was *embedded in the
...
- **There was no path from "we have a disk now" to "use it for
  binaries."** The whole point of the previous chapter was to make a disk
