# Chapter 33 — Environment variables and a real PATH walk

The shell from chapter 30 hardcoded `/bin/` as the only place to
...
`resolve_path` in chapter 30 just prepended `/bin/`. Now it does
...
kernel/core/main.c          banner -> milestone 24
