# Chapter 30 — A `time` builtin for the shell
...
That's it. One file, ~50 lines. Smallest change in the book.
Highest leverage-per-line of any change in the book so far.
