# Chapter 35 — Shell quoting

The shell from chapter 34 expanded `$VAR` inside any input. This
...
- The two-buffer model (raw vs expanded) from chapter 34.
...
kernel/core/main.c       banner -> milestone 26
```
