# Chapter 57 — A userspace wallpaper, and the yield/IRQ race it
# uncovered
...
Chapter 53 painted a gradient on the framebuffer from inside the
kernel.  Chapter 55 swapped that for a JPEG-converted BGRA blob
...
chapter 54.  We needed a runtime query.
...
With the previous half functionally complete and the resolution issue fixed,
...
through chapter 56 we never had four yield-heavy processes
...
descriptor ring. A later chapter's repeat-stress harness caught the
