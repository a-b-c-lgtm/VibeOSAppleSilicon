# Chapter 44 — Cursor movement and readline keybindings

Chapter 43 gave us a raw-mode line editor with arrow-key history but
...
side from chapter 43 (single-byte raw read, no echo, no buffering)
...
- `userspace/sh/sh.c`:
  ...
  - Help text updated.
- `kernel/core/main.c`: banner -> milestone 35.
