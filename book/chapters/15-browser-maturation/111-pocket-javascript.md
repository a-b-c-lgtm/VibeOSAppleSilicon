...
Chapter 110a closed the cookie/SOP loop and announced — at
...
`--check-sop` pattern from chapter 110a:
...
The lesson is the same one chapters 73 and 79 taught
...
- The chapter 110a SOP gate is no longer theoretical:
