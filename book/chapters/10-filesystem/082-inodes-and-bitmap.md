# Chapter 82 — Inodes, dirents, and the free-space bitmap

Chapter 81 picked the design.  This chapter writes the code.
...
through chapters 20..79 without us silently rewriting the
...
two devices.  Until chapter 82 it was hard-coded to a single
...
From chapter 81, OSFS-2 uses 4 KiB blocks and lays them out
...
Chapter 83 will add a doubly-indirect tier; chapter 84 won't
need one at all.
...
one for the new block's zero fill.  That's a chapter 83
problem.
...
- [Chapter 81](081-writable-fs-design.md) — design
- [Chapter 19](../05-devices/019-virtio-blk.md) — virtio-blk
- [Chapter 20](../05-devices/020-osfs-and-mount.md) — OSFS-1
