...
drive the resulting window. After milestone 51 added the
...
which had been quietly broken since M51 for the same reason
...
- Drop the manual `launcher\n` spawn from `test_launcher.py`
  entirely — since M46 init auto-spawns the launcher, the
