# Chapter 66 — The HTML tokenizer

[Chapter 65](../07-networking/065-url-and-http-parser.md) finished the
networking story: by the end of it we could fetch a URL,
...
- **The token is ~12 KiB.** That is the reason we malloc
  it: see [Chapter 65](../07-networking/065-url-and-http-parser.md)'s
...
The same rule from the URL parser chapter applies, even more strongly:
...
The DOM-construction chapter ([Chapter 67](067-dom-construction.md))
consumes this token stream and builds an actual
tree. It will need:
...
After the DOM lands we get CSS in [Chapter 68](068-css-parser.md),
layout in [Chapter 69](069-block-and-inline-layout.md), and finally the GUI
binding in [Chapter 70](070-bin-browser.md). At the very end we
