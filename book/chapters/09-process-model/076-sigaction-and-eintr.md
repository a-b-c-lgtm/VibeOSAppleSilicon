# Chapter 76 — Catching signals: sigaction, masks, EINTR
...
> the interrupted context. Builds on chapter 75 (signal
> delivery).
...
- Chapter 75 — Signals, SIGINT
- Chapter 13 — SVC and the syscall ABI
- Chapter 26 — User stack layout (we extend it for the
  signal frame)
...
- The job-control machinery in chapter 78.
