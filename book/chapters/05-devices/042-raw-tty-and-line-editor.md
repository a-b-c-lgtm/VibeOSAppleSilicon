# Chapter 42 — Raw TTY mode and the shell line editor
...
- **Real signals**: Ctrl-C just cancels the current edit; it does not
  ...
  milestone — see chapter 29 for the previous mention.
- **Persistent history** across reboots: needs disk-backed writable
  FS (chapter 40 only gives us tmpfs, which evaporates on reboot).
