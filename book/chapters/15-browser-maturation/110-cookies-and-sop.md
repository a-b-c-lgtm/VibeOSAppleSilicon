...
Forms (chapter 109) let users log in. Without cookies there
...
clock that landed in [chapter 95](../12-system-services/95-rtc-and-wallclock.md).
...
chapter 111 will ship a JS evaluator but it doesn't have a
...
- **Cross-origin form blocking.** That's the other half of
  the policy and ships as [chapter 110a](110a-cross-origin-form-blocking.md):
...
[chapter 82](../11-disk-and-filesystems/82-write-back-and-fsync.md)
already gives us `fsync()`, and because `time(NULL)` from
[chapter 95](../12-system-services/95-rtc-and-wallclock.md)
...
- The browser can persist preferences (when chapter 111
...
- [Chapter 110a](110a-cross-origin-form-blocking.md)
...
- Chapter 111 (pocket JavaScript) gets to assume the jar
